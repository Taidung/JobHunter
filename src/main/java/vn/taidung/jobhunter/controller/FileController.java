...
import vn.taidung.jobhunter.domain.response.file.ResUploadFileDTO;
import vn.taidung.jobhunter.service.FileService;
import vn.taidung.jobhunter.util.annotition.ApiMessage;
import vn.taidung.jobhunter.util.error.StorageException;
...
public class FileController {
    ...
    @Value("${taidung.upload-file.base-uri}")
